...
<div class="contentBody">
  ...
  <div class="col-md-12 mainTitle">
    <strong><?php echo $CLICSHOPPING_QuickUpdate->getDef('text_quick_update'); ?></strong></div>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <div class="col-md-12">
            <?php echo $CLICSHOPPING_QuickUpdate->getDef('text_intro'); ?>
          </div>
        </div>
        <div class="separator"></div>
        ...
        <div class="col-md-12 text-center">
          <div class="form-group">
            <div class="col-md-12">
              <?php
                echo HTML::form('configure', CLICSHOPPING::link(null, 'A&Catalog\QuickUpdate&Configure'));
                echo HTML::button($CLICSHOPPING_QuickUpdate->getDef('button_configure'), null, null, 'primary');
                echo '</form>';
              ?>
            </div>
          </div>
