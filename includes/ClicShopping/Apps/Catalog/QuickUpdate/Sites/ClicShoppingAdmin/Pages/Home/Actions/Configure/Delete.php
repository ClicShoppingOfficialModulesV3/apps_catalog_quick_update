<?php
  ...
  class Delete extends \ClicShopping\OM\PagesActionsAbstract
  {
    ...
    public function execute()
    {
      ...
      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_QuickUpdate->getDef('alert_module_uninstall_success'), 'success', 'QuickUpdate');
    ...
    private static function removeMenu()
    {
      ...
      if ($Qcheck->fetch()) {
        ...
        $QMenuId->bindValue(':app_code', 'app_catalog_quick_update');
        $QMenuId->execute();
        ...
        $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_catalog_quick_update']);
      }
    }
  }